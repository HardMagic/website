...
export const mediaManifest = [
  {
    ...
    alt: {
      ...
      rationale: 'The photograph documents a recognizable HardMagic visual motif.',
    },
    caption: {
      kind: 'none',
      text: null,
      rationale: 'The image is retained as an owned identity reference, not current homepage artwork.',
    },
    crop: {
    ...
    provenance: {
      ...
      source: 'Recovered from the 2015 HardMagic website source collection.',
      owner: HARDMAGIC,
      license: 'Owned HardMagic source asset.',
      restrictions: 'Company identity reference only; any publication requires an explicit provenance caption.',
    },
    generated: notGenerated,
    reviewStatus: 'approved',
    reuseRule: 'One captioned company-history use is permitted; it is not assigned to the homepage.',
  },
  {
    id: 'hardmagic-wordmark',
    title: 'HardMagic infinity wordmark',
    ...
    caption: {
      kind: 'required',
      text: 'The HardMagic infinity wordmark, drawn as a tight contemporary signature.',
      rationale: 'The caption identifies the current primary mark.',
    },
    crop: {
    ...
    provenance: {
      truthStatus: 'owned-existing',
      source: 'HardMagic identity redesign, August 13, 2026.',
      owner: HARDMAGIC,
      license: 'Owned HardMagic brand asset.',
      restrictions: 'Primary identity. Preserve vector path geometry, aspect ratio, and clear space.',
    },
    generated: notGenerated,
    reviewStatus: 'approved',
    reuseRule: 'Use globally for primary HardMagic identity; do not redraw or typeset a substitute.',
  },
  {
    id: 'client-mark-disney',
    title: 'Disney documented-experience mark',
    ...
    alt: {
      kind: 'logo-label',
      text: 'Disney',
      rationale: 'The mark identifies documented brand experience.',
    },
    caption: {
      kind: 'required',
      text: null,
    ...
    provenance: {
      ...
      license: 'Third-party trademark used only to identify substantiated project experience.',
  ...
  {
    id: 'client-mark-zico',
    title: 'ZICO documented-experience mark',
  ...
  },
  {
    ...
    title: 'Jamba Juice documented-experience mark',
  ...
  {
    id: 'client-mark-abc',
    title: 'ABC documented-experience mark',
    ...
    alt: {
      kind: 'logo-label',
      text: 'ABC',
      rationale: 'The official vector identifies documented brand experience.',
    },
    caption: {
      kind: 'required',
      text: null,
    ...
    provenance: {
      ...
      license: 'Third-party name used only to identify substantiated project experience.',
      restrictions: 'No current affiliation, endorsement, decorative hero use, or unsupported project claim.',
    },
    generated: notGenerated,
    reviewStatus: 'approved-with-restrictions',
  ...
  },
  {
    ...
    alt: {
      kind: 'empty',
      text: '',
      rationale: 'The abstract frames are decorative and not an authentic media library or interface.',
    },
    caption: {
      kind: 'none',
      text: null,
  ...
  },
  {
    ...
    filename: 'src/assets/editorial/generative-operations-4k.avif',
    ...
    alt: {
      kind: 'descriptive',
      text: 'A creative operator directs photographic material across an illuminated working table in a dark studio.',
      rationale: 'The working gesture and physical media carry the homepage metaphor.',
    },
    caption: {
      kind: 'required',
    ...
    provenance: {
      ...
      source: 'HardMagic generated editorial asset; 1536 × 1024 source enhanced to a 3840 px rendition with HardMagic RealESRGAN x4plus.',
      owner: HARDMAGIC,
    ...
    generated: {
      ...
      workflow: 'OpenAI ImageGen, August 12, 2026; direct generation with no reference image; human-selected; HardMagic RealESRGAN x4plus enhancement and 3840 px AVIF rendition, August 13, 2026.',
    },
    reviewStatus: 'approved-with-restrictions',
    reuseRule: 'Homepage lead and the named generative-operations editorial series only; every use must retain conceptual-art disclosure.',
  },
  {
    ...
    alt: {
      kind: 'descriptive',
      text: 'A creative director gestures toward a wall of projected frames in a dark working room.',
      rationale: 'The directing gesture and field of candidate images carry the editorial metaphor.',
    },
    caption: {
      kind: 'required',
  ...
  },
  {
    ...
    filename: 'src/assets/editorial/dream-media-specimen-4k.avif',
    type: 'generated-concept',
    roles: ['campaign-art', 'editorial-interlude'],
    routes: ['/', '/insights/dream-in-reality/', '/products/studio/'],
    alt: {
      kind: 'descriptive',
      text: 'A luminous waveform passes through film, paper, and a small projection apparatus on a black field.',
      rationale: 'The impossible physical media specimen carries the scenario argument.',
    },
    caption: {
      kind: 'required',
    ...
    provenance: {
      truthStatus: 'generated-concept',
      source: 'HardMagic generated editorial asset; 1774 × 887 source enhanced to a 3840 px rendition with HardMagic RealESRGAN x4plus.',
      owner: HARDMAGIC,
      license: 'Owned HardMagic generated editorial asset, subject to workflow and reference-rights verification.',
    ...
    reviewStatus: 'approved-with-restrictions',
    reuseRule: 'Limited to the Dream in Reality series plus the home and Studio future-media field, always with disclosure.',
  },
  {
    id: 'media-alchemy-ritual',
    title: 'Media alchemy ritual',
    filename: 'src/assets/editorial/media-alchemy-ritual-4k.avif',
    type: 'generated-concept',
    roles: ['hero', 'editorial-interlude', 'campaign-art'],
    routes: ['/', '/products/studio/', '/horizon/', '/horizon/*', '/briefs/*'],
    alt: {
      kind: 'descriptive',
    ...
    generated: {
      ...
      workflow: 'OpenAI built-in ImageGen; direct generation; human-selected; 1920 × 1080 authored crop; HardMagic RealESRGAN x4plus enhancement and 3840 × 2160 AVIF rendition, August 13, 2026.',
    },
    reviewStatus: 'approved-with-restrictions',
    reuseRule: 'May recur within the named Horizon 2035 series and the home/Studio multimodal field; every use must retain disclosure.',
  },
  {
    id: 'hardmagic-future-command-2026',
    title: 'Future media command',
    filename: 'src/assets/editorial/hardmagic-future-command-desktop.avif',
    type: 'generated-concept',
    roles: ['hero'],
    routes: ['/'],
    alt: {
      kind: 'descriptive',
      text: 'AI-generated campaign scene of creative directors orchestrating a monumental film set of sculptural fabric, cameras, and practical light.',
      rationale: 'The human directing group and production-scale environment establish the homepage point of view.',
    },
    caption: {
      kind: 'required',
      text: 'HardMagic-directed generative concept image; not client or product evidence.',
      rationale: 'The disclosure prevents campaign artwork from being mistaken for documentary proof.',
    },
    crop: {
      preferredAspect: '2:1',
      desktop: 'Use the 3840 × 1920 master with the left field reserved for headline copy.',
      narrow: 'Use the 1200 × 1498 authored east crop centered on the directing group, camera, and practical set.',
      focalPoint: { x: 72, y: 58, unit: 'percent' },
      safeArea: 'Keep the left field quiet on desktop; retain the directors and camera on narrow screens.',
    },
    provenance: {
      truthStatus: 'generated-concept',
      source: 'OpenAI built-in ImageGen fallback direct generation, August 13, 2026; no reference images. HardMagic Studio endpoint was unavailable at generation time.',
      owner: HARDMAGIC,
      license: 'Owned HardMagic generated editorial asset.',
      restrictions: 'Homepage campaign artwork only; never product, customer, facility, or performance evidence.',
    },
    generated: {
      isGenerated: true,
      disclosure: 'AI-generated campaign artwork, selected and art-directed by HardMagic.',
      promptIntent: 'A monumental real production world where senior human direction remains visibly central to advanced media-making, with desktop copy space and responsive crop safety.',
      workflow: 'HardMagic Studio FLUX route attempted first but blocked by DNS; OpenAI built-in ImageGen fallback; direct generation; human-selected; authored 2:1, 16:9, and 4:5 AVIF crops, August 13, 2026.',
    },
    reviewStatus: 'approved-with-restrictions',
    reuseRule: 'Homepage lead only.',
  },
  {
    id: 'archive-cathedral-2035',
    title: 'Memory cathedral, 2035',
    ...
    provenance: {
      ...
      owner: HARDMAGIC,
      license: 'Owned HardMagic generated editorial asset.',
      restrictions: 'Conceptual editorial use only; never facility, product, client, or media-library evidence.',
    },
    generated: {
      isGenerated: true,
      disclosure: 'AI-generated conceptual scenario art, selected and art-directed by HardMagic.',
      promptIntent: 'A cathedral-like 2035 memory space joining physical preservation, institutional knowledge, and luminous computation.',
      workflow: 'OpenAI built-in ImageGen; direct generation; human-selected; 1920 × 1080 authored crop; HardMagic RealESRGAN x4plus enhancement and 3840 × 2160 AVIF rendition, August 13, 2026.',
    },
    reviewStatus: 'approved-with-restrictions',
  ...
  },
  {
    ...
    filename: 'src/assets/editorial/audience-dreamfield-2035-4k.avif',
    type: 'generated-concept',
    roles: ['hero', 'editorial-interlude', 'campaign-art'],
    routes: ['/', '/products/studio/', '/horizon/*', '/briefs/*'],
    alt: {
      kind: 'descriptive',
    ...
    reviewStatus: 'approved-with-restrictions',
    reuseRule: 'May recur inside the Horizon 2035 series and the home/Studio multimodal field, always with disclosure.',
  },
  ...([
    {
      id: 'HM-P01',
      title: 'The original raptor — restored source master',
      type: 'photography',
      roles: ['hero', 'archive-proof'],
      routes: ['/company/history/'],
      alt: 'A restored view of the original HardMagic bird of prey in flight.',
      caption: 'The enduring HardMagic raptor, restored from the company source collection.',
      aspect: '16:9',
      ...
      source: 'Planned restoration derived from the existing raptor source asset.',
      restrictions: 'Restoration must not invent missing photographic detail or alter the documented subject.',
      parentAssetId: 'legacy-raptor',
      reuse: 'Company-history lead only; it is not assigned to the homepage.',
    },
    {
      id: 'HM-P02',
    ...
    },
    {
      ...
      alt: 'A real owned media library in Photo Curator with related frames, ratings, and a selection state; final wording requires capture review.',
      caption: 'State media ownership, product version, and what the selected state demonstrates.',
      aspect: '16:10',
      desktop: 'Show sufficient collection density to explain grouping and judgment.',
    ...
    },
    {
      ...
      caption: 'Describe the actual media practice without revealing client or security-sensitive labels.',
      aspect: '3:2',
    ...
    {
      id: 'HM-P22',
      title: 'Brand-world source collection',
      type: 'archival-scan',
      roles: ['archive-proof', 'observation'],
      routes: ['/company/history/', '/company/experience/'],
      alt: 'Authenticated HardMagic work presented as physical or scanned artifacts; final wording is artifact-specific.',
      ...
      focal: null,
      source: 'Planned recovery and digitization of the HardMagic company source collection.',
    ...
    },
    {
      ...
      focal: null,
      source: 'Planned recovery of an authenticated, authorized source artifact.',
      restrictions: 'No publication until role, rights, and non-endorsement language are approved; no logo wallpaper.',
      reuse: 'Company experience and dated project context only; never a generic credibility badge.',
    },
    {
      id: 'HM-P24',
